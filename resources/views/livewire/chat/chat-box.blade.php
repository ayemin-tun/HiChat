<div class="w-full overflow-hidden" x-data="{height:0,conversationElement:document.getElementById('conversation')}"
    x-init="
    ...
    <div class="border-b flex flex-col h-full grow overflow-y-scroll">
        ...
        <div id='conversation'
            ...
            <div @class([ 'max-w-[85%] md:max-w-[78%] flex w-auto gap-2 relative mt-2' ,'ml-auto'=>
                ...
                <div @class([ 'flex flex-wrap txt-[15px] rounded-xl p-2.5 flex flex-col text-black '
                    , 'rounded-bl-none border bg-gray-200'=>!($message->sender_id=== auth()->id()),
        ...
        <footer class="shrink-0 z-10 bg-white inset-x-0">
            <div class="p-2 border-t">
                <form action="post" autocapitalize="off" x-data="{body:@entangle('body')}"
                    @submit.prevent="$wire.sendMessage">
                    @csrf
                    {{-- <input type="hidden" autocomplete="false" style="display: none;"> --}}
                    <div class="grid grid-cols-12">
                        <input x-model="body" type="text" placeholder="Write your message here" maxlength="1700"
                            class="col-span-10 bg-gray-200 border-0 outline-0 focus:border-0 focus:ring-0 hover:ring-0 rounded-lg focus:outline-none">

                        <button x-bind:disabled="!body.trim()"
                            class="col-span-2 flex gap-2 justify-center text-blue-800 items-center" type="submit">
                            Send
